...
public class ResultReceiveIntent {
    public static String SEND_RESULT_INTENT = "send.result.intent.intent";

    public static String SEND_USER_INDEX_INTENT = "send.user.number.intent";
